...
const SingleVacancy = () => {
  return (
    <Link to={'/vacancy/123123'}>
      <div className={styles.singlaVacancyContainer}>
        <div className={styles.vacancyName}>Менеджер-дизайнер</div>
        <div className={styles.vacancyMainPart}>
          <div className={styles.salaryInfo}>з/п от 70000 rub</div>
        ...
        <div className={styles.footer}>
          ...
          <div className={styles.footerLocation}>Новый Уренгой</div>
        </div>
      </div>
    </Link>
  );
